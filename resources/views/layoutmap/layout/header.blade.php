            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item mx-0 mx-lg-1">
                        <a style="color: #497689;" class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="{{route('login')}}" id="header_starttour">Home</a>
                    </li>
                    <li class="nav-item mx-0 mx-lg-1">
                    ...
                    <li class="nav-item mx-0 mx-lg-1" id="li_person">
                        <a style="color: #497689;" class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#">{{ trans('messages.Youraccount') }} <i class="fas fa-sort-down"></i></a>
                        <div id="div_person">
                            <?php $user = Auth::user();?>
                            @if($user->us_type == "1")
                    ...
                    @else
                    <li class="nav-item mx-0 mx-lg-1">
                        <a style="color: #497689;" class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#" id="openModalLogin">Login</a>
                    </li>
                    @endif
